...
class CanvasPainting {
  ...
  emitCanvasOperation(): void {
    if (this._currentOperation != null) {
      ...
      this._canvasObservers.map((observer) => {
  ...
  mousedown(event: CanvasEvent): void {
    ...
    this._currentOperation = {
      beginLocation: loc,
      locations: [],
      brushSize: this._context.lineWidth,
    };
  }
