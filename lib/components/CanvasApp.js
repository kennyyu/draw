        ...
        <Modal
          ...
          <div className='modal-body'>
            <CanvasSidebar
              ...
              onBrushSizeChange={this.props.onBrushSizeChange}
              onBrushColorChange={this.props.onBrushColorChange}
              onClearCanvas={this.props.onClearCanvas}
              onNewCanvas={this.props.onNewCanvas}
              onGoToCanvas={this.props.onGoToCanvas}
...
class CanvasApp extends React.Component {
  ...
  render(): any {
    ...
    var shouldShowSidebar = (sidebarWidth > 400);
    if (!shouldShowSidebar) {
      canvasWidth = this.props.windowWidth;
      sidebarWidth = 0;
    }
    ...
    if (shouldShowSidebar) {
      return (
        <div>
          <Navbar staticTop fluid brand='Doodle!' style={styles.navbar}>
          </Navbar>
          <div>
      ...
      return (
        <div>
          <Navbar staticTop fluid brand='Doodle!'>
            <Nav>
              <ModalTrigger modal={
                <MyModal
                  brushSize={this.state.brushSize}
                ...
                <Button bsStyle='primary' bsSize='large'>Canvas Options</Button>
              </ModalTrigger>
            </Nav>
          </Navbar>
          <div>
